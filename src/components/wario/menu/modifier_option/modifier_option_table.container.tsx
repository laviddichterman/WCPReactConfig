...
import { DisableDataCheck, DISABLE_REASON, IMoney, IOption, IOptionType, IWInterval } from '@wcp/wcpshared';
  ...
  return (
      <TableWrapperComponent
        ...
        columns={[
          ...
          { headerName: "Price", field: "price", valueGetter: (v: IMoney) => `$${Number(v.amount / 100).toFixed(2)}` },
